...
A couple of things to note about homeworks:
- Homeworks are to be completed **individually**. Yes, this is a change from previous semesters, but we have [good reason](/resources/No-group-assignments.html) to believe that the group homeworks hamper learning instead of facilitating it. 
- The homework average consists 25% of your final course grade. We will use the highest 18 scores to calculate your homework average for your final course grade. Since there are expected to be 22 problems, this means that 4 problems will be dropped (>1-2 homeworks).
...
- **We will give zero points for long and tedious solutions** (i.e., solutions that are longer than the official solutions by a significant amount). We reserve the right to not even read your solution if it is exceedingly and unnecessarily long. If your solutions seem too long - rewrite it to be short and precise. 
...
Regrade requests would be open for a week once grades are released. The exception to this is any assignments done near the end of the semester. Due to registrar grade submission deadlines, we likely won't have time for regrades. Regrade requests are not intended for arguing about point allocation or whether the grading scale is fair.

Unfortunately, certain students think that they can tire us into giving them points that they did not earn, by continually asking for unjustified regrade requests. As such, superfluous, argumentative, and repetitive regrade requests, after an appropriate warning, would result in a zero on the relevant questions - please do not waste our time.
