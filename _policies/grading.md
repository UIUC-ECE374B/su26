...
- [Homeworks](/homeworks.html): 25%
    ...
    - Specifically, we will include only the top 14 homework problems (including the lab problems) scores in computing your final grade. We expect to grade 9 homeworks, each with 2-3 problems. Should for some reason we would grade less homework problems, we will still use the top 14 homework problems.
...
- [Exams](/exams.html): 75%
    ...
    - If you miss any of the midterms, you can take the final and whatever you get on the final will be slotted into the midterm you get. Similarly, even if you took all three midterms but feel like you want a chance to perform better, you can take the final with the caveat that whatever you get on the final will replace your lowest midterm grade. This policy is simply to ensure that everyone that takes the final, takes it seriously and I can apply a similar curve to the final that I do for the midterms. 
